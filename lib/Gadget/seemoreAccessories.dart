...
class SeeMoreAccessories extends StatefulWidget {
  SeeMoreAccessories({super.key});
  ...
  @override
  State<SeeMoreAccessories> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<SeeMoreAccessories> {
  late bool akses;
  @override
  void initState() {
    super.initState();
                  ...
                  builder: (BuildContext context, AsyncSnapshot snapshot) {
                    if (snapshot.hasData) {
                      List<dynamic> filteredData = snapshot.data!
                          .where((gadget) =>
                              (akses && gadget.category == 'accessories'))
                          .toList();
