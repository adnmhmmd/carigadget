...
class SeeMorePhone extends StatefulWidget {
  SeeMorePhone({super.key});
  ...
  @override
  State<SeeMorePhone> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<SeeMorePhone> {
  late bool akses;
  @override
  void initState() {
    super.initState();
